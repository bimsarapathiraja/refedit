...
# python main.py --name omni --base configs/finetune_combined_mb_omni.yaml --train --gpus 0,1 --logdir output_dir
# python main.py --name refedit --base configs/finetune_combined_ip2p.yaml --train --gpus 0,1 --logdir output_dir